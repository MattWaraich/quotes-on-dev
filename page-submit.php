			...
			<section class="quote-submission">
				<header class="entry-header">
					...
					<?php if( is_user_logged_in() && current_user_can( 'edit_posts' ) ): ?>
						...
						<div>
							<label for="quote-source-url">Provide URL of quote source (if available</label>
					...
					<?php else: ?>	
						<p> Sorry, you're not logged in to submit a quote :(</p>
						<p>
							<a href="<?php wp_login_url(); ?>">
							Click here to locale_get_display_name
							</a>
						</p>
